...
/*
 * Geekofia Jekyll Search v1.0.0
 * by chankruze
 * Copyright 2019 and beyond, Chandan Kumar Mandal
 */
...
! function() {
  ...
  ! function(t) {
      var o = {
              ...
              searchResultTemplate: '<a href="{url}" title="{desc}" class="dropdown-item results-dropdown">{title}<br><small>{date}</small></a>',
              templateMiddleware: Function.prototype,
              sortMiddleware: function() {
                  return 0
              },
              noResultsText: '<span id="no-results">No results found</span>',
              limit: 10,
              fuzzy: !1,
              exclude: []
          },
